    ...
    <article className="article-page" dir="rtl" lang="ar">
      ...
      <div className="article-body">
        ...
        <p className="article-opening-lines">
          في الفيزياء، يُقال إن أي نظام يُهمل يميل إلى الفوضى؛ صياغةٌ تقنية، لكنها تصبح سياسية حين يتراجع
          الاهتمام بالبنية والقواعد طويلة الأمد.
        </p>
        <p>
          وليس المقصود أن نُحوّل العلم إلى شعار؛ المقصود أن نلتقط تشابهاً دقيقاً: ما يحدث في الخليج اليوم
          يشبه — في شكل التراكم — ما يحدث حين تضعف الطبقة الاستراتيجية وتعلو الطبقة الانفعالية في اتخاذ
          القرار.
        </p>
        ...
        <p>
          ...
          تأجيل المبادرة إلى حين «ينصلح الحال» من تلقاء نفسه.
        </p>
        <p>
...
تراجع عمق التكوين الفكري والإداري في أجيال قيادية، لا بصورة مفاجئة، بل تدريجياً وبمرور الزمن.`}
        ...
        <p className="article-num-block">
          {`٢
هيمنة قرارات تُبنى على العاطفة والمصلحة الآنية، بدلاً من استراتيجية تتحمّل الاختبار والمتابعة.`}
        </p>
        <p className="article-num-block">
          {`٣
...
وجود أطر التعاون «على الورق» دون أن تترجم إلى تنسيق حقيقي في الملفات الحساسة.`}
        ...
        <p>
          ...
          أحياناً الاثنين معاً، في تداخل يصعّب قراءة المشهد من زاوية واحدة.
        </p>
        <p className="article-divider">— — —</p>
        <p>
